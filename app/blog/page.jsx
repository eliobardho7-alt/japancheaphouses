...
import { Lock, Calendar, Clock, User as UserIcon, Heart } from 'lucide-react';
        ...
        <div className="container-custom">
          ...
          <div className="mb-12">
            ...
            <p className="text-brand-gray max-w-2xl">
              Featured properties, market insights, and guides to investing in Japan real estate.
            </p>
          </div>
          ...
          <div className="mt-16 bg-brand text-white p-12 text-center">
            ...
            <p className="text-white/80 max-w-2xl mx-auto mb-6">
              Get exclusive access to all our premium property listings and join our community of
              investors for just $5/month.
            </p>
            <Link
              href="/pricing"
